...
import { getPublishedCoursesSync, loadPublishedCourses } from '../data/adminSiteData';
...
function readCourses(): Course[] {
  return getPublishedCoursesSync(FALLBACK, 'military');
}
...
export function Courses() {
  ...
  useEffect(() => {
    const load = async () => {
      const c = await loadPublishedCourses(FALLBACK, 'military');
